...
public class SacolaoDoTobao {
	...
	public static void main(String[] args) {
		...
		System.out.println("Sacolão do Tobão");
		System.out.println("Digite o que vai comprar hoje: Maça ou Morango ou Ambos: ");
		...
		if (entrada.equalsIgnoreCase("Ambos")) {
			...
			if (totalKg < 5) {
				...
				System.out.println("Ganhou mais desconto: R$" + new DecimalFormat("##.00").format((preco1 - desconto1)));
				...
				System.out.println("Ganhou mais desconto: R$" + new DecimalFormat("##.00").format((preco2 - desconto2)));
